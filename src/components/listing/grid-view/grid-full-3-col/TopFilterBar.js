          ...
          <ul className="p-0 text-center text-xl-start">
            ...
            <li className="list-inline-item position-relative">
              <button
                ...
                data-bs-auto-close="outside"
              >
                Villa Tipi <i className="fa fa-angle-down ms-2" />
              </button>
              <div className="dropdown-menu">
                <div className="widget-wrapper bdrb1 pb25 mb0 pl20">
                  <h6 className="list-title">Villa Tipi</h6>
            ...
            <li className="list-inline-item position-relative">
              <button
                ...
                data-bs-auto-close="outside"
              >
                Fiyat <i className="fa fa-angle-down ms-2" />
              </button>
            ...
            <li className="list-inline-item position-relative">
              <button
                ...
                data-bs-auto-close="outside"
              >
                Yatak Odası / Banyo <i className="fa fa-angle-down ms-2" />
              </button>
            ...
            <li className="list-inline-item">
              ...
              >
                <i className="flaticon-settings me-2" /> Filtreler
              </button>
            </li>
          </ul>
        </div>
        ...
        <div className="page_control_shorting d-flex align-items-center justify-content-center justify-content-sm-end">
          <div className="pcs_dropdown pr10 d-flex align-items-center">
            ...
            <select className="form-select" onChange={(e)=>setCurrentSortingOption && setCurrentSortingOption(e.target.value)} >
              ...
              <option>En Sevilenler</option>
              <option>Best Match</option>
              <option>Fiyat - En Ucuz</option>
              <option>Fiyat - En Pahalı</option>
            </select>
          </div>
